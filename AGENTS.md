...
- This project currently implements Raw LoRa, not LoRaWAN. Do not describe `TxDone` as peer reception, and do not treat an RFM95 as a LoRaWAN gateway.
...
- Keep `ILoraRadio` free of console, transport, and LoRaWAN-specific concerns.
